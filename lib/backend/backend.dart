...
import 'schema/tipo_pedido_record.dart';
...
export 'schema/tipo_pedido_record.dart';
...
/// Functions to query TipoPedidoRecords (as a Stream and as a Future).
Future<int> queryTipoPedidoRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      TipoPedidoRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<TipoPedidoRecord>> queryTipoPedidoRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      TipoPedidoRecord.collection,
      TipoPedidoRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<TipoPedidoRecord>> queryTipoPedidoRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
