  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<UsuariosRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final profilePageUsuariosRecord = snapshot.data!;
              ...
              child: Column(
                ...
                children: [
                              ...
                              child: Padding(
                                ...
                                child: InkWell(
                                  ...
                                  child: ClipRRect(
                                    ...
                                    child: Image.network(
                                      profilePageUsuariosRecord.photoUrl,
                                      width: 100.0,
                                      height: 100.0,
                                      fit: BoxFit.cover,
                                    ),
                  ...
                  Padding(
                    ...
                    child: Text(
                      profilePageUsuariosRecord.name,
                  ...
                  Text(
                    profilePageUsuariosRecord.email,
                    ...
                    child: Padding(
                      ...
                      child: StreamBuilder<List<PedidoRecord>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<PedidoRecord> containerPedidoRecordList =
                              snapshot.data!;
                          return Container(
                                                ...
                                                child: Padding(
                                                  padding: EdgeInsetsDirectional
                                                      .fromSTEB(
                                                          0.0, 0.0, 12.0, 0.0),
                                                  child: Text(
                                                    profilePageUsuariosRecord
                                                                    .endereco !=
                                                                null &&
                                                            profilePageUsuariosRecord
                                                                    .endereco !=
                                                                ''
                                                        ? '${profilePageUsuariosRecord.endereco}'
                                                        : 'Endereço',
